                ...
                <form class="col-12" id="frmCotizacionfiltro">
                    <div class="col-12 mb-3">
                        <div class="input-group input-group-sm">
                            <div class="col-1">
                                <label for="txt_fil_ven_fec1" class="col-form-label">Fecha</label>
                            </div>
                            <div class="input-group-prepend">
                                <input class="form-control" name="txt_fil_ven_fec1" type="text" id="txt_fil_ven_fec1" value="<?php echo date('d-m-Y'); ?>" readonly>
                            </div>
                            <div class="input-group-prepend">
                                <label for="txt_fil_ven_fec2" class="input-group-text" style="border-left: 0">-</label>
                            </div>
                            <div class="input-group-prepend">
