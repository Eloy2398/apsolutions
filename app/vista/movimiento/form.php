        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-3">
              ...
              <input type="text" id="txtfecha" name="txtfecha" class="form-control first-input" value="<?= date('d-m-Y'); ?>" readonly />
            </div>
            <div class="col-4">
          ...
          <div class="col-12">
            ...
            <input type="text" id="txtanexo" name="txtanexo" class="form-control" required />
          </div>
