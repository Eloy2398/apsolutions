      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <!-- Modal -->
            <div class="modal fade" id="mdlCategoria" tabindex="-1" aria-hidden="true">
            ...
            <div class="card">
              <div class="card-header header-elements justify-content-between">
                ...
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#mdlCategoria"><i class="bx bx-plus"></i> Agregar</button>
              </div>
